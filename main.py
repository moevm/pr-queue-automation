...
parser.add_argument("-r", "--root", type=str, help="Корневое название репозитория (логин владельца репозитория)")
parser.add_argument("-tp", "--typew", type=str, help="тип работы (lb или cw)")
parser.add_argument("-g", "--gllink", type=str, help="Ссылка на гугл таблицу с дискорд именами и статусами допуска")
